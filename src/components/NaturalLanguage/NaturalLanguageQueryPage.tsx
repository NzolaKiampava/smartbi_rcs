          ...
          <div className="flex flex-wrap gap-2">
            {exampleQueries.map((example, index) => (
              <button
                ...
                className="text-xs px-3 py-2 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition-colors"
                disabled={isProcessing}
              >
                {example}
              </button>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900">{q.input}</p>
